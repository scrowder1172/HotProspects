...
This is Project 16 in Paul Hudson's 100 Days of SwiftUI course. This project creates an iOS app that documents people the user has met and gives the user a QR code that they can share with other people to quickly get added to their friends list.
